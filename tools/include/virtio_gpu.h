#ifndef _axvisor_VIRTIO_GPU_H
#define _axvisor_VIRTIO_GPU_H
...
// Maximum number of scanouts supported by axvisor's virtio_gpu implementation
#define axvisor_VIRTIO_GPU_MAX_SCANOUTS 1
...
typedef struct virtio_gpu_simple_resource {
    ...
    // vmx will directly map to the virtual memory space of axvisor-tool, this
...
typedef struct virtio_gpu_dev {
    ...
    GPUScanout scanouts[axvisor_VIRTIO_GPU_MAX_SCANOUTS];
    // TODO: Initialize requested_state
    // Requested states negotiated by these scanouts
    GPURequestedState requested_states[axvisor_VIRTIO_GPU_MAX_SCANOUTS];
